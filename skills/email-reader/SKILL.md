...
3. If user asks for history:
   ...
   - summarize top items
   - If user asks for upcoming interview/test schedule, call `GET http://127.0.0.1:8010/api/schedules/upcoming?limit=20&days=14`
...
- Upcoming schedules:
  - `curl -sS "http://127.0.0.1:8010/api/schedules/upcoming?limit=20&days=14"`
- Heartbeat status:
